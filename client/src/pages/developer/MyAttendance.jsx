...
const mockLogs = [
  ...
  { date: 'May 27, 2026', checkIn: '09:48 AM', checkOut: '06:00 PM', status: 'Late', hours: 8.2 },
  { date: 'May 26, 2026', checkIn: '09:12 AM', checkOut: '05:45 PM', status: 'Present', hours: 8.5 },
];
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <StatCard title="Total Logged Hours" value="25.2 Hrs" icon={Clock} />
      </div>

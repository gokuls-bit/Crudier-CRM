...
import DeveloperProfilesSection from '../../components/shared/DeveloperProfilesSection';
  ...
  return (
    <div className="flex flex-col gap-8 max-w-4xl">
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        <div className="glass-panel p-6 rounded-xl border border-white/5 flex flex-col md:flex-row gap-6 items-start flex-1 w-full">
      ...
      <div className="glass-panel p-6 rounded-xl border border-white/5 w-full">
